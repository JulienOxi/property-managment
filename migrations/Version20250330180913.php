 ...
 */
final class Version20250330180913 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE financial_entry ADD CONSTRAINT FK_5A40775F9033212A FOREIGN KEY (tenant_id) REFERENCES tenant (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
