 ...
 */
final class Version20241219163903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, mobile_phone VARCHAR(25) DEFAULT NULL, street VARCHAR(255) NOT NULL, street_number VARCHAR(10) DEFAULT NULL, zip_code SMALLINT NOT NULL, city VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
